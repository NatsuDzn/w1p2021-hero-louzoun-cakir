...
| État | Une décision ou un événement aléatoire survenu pendant l'aventure a un impact sur la suite, au moins une fois. ** | ✅Selon le personnage il y'a des étapes qui saute comme l'intro ou les deux premières étapes |
| État | Le choix du personnage et/ou ce qu'il s'est passé pendant l'aventure impactent l'écran de fin. | ✅Le nom du personnage apparait à la fin |
...
| Sauvegarde | Lorsqu'on quitte le jeu et qu'on revient plus tard à la page d'accueil (sur le même navigateur), il est possible de reprendre l'aventure où on l'avait laissée | ⚠️ |
| Multimédia | L'expérience présente une vidéo ou plus | ✅Si l'utilisateur choisit le 1er ou le 3eme personnage une vidéo se présentera a lui |
